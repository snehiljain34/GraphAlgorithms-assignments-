...
int main()
{
	...
	// figure
    // code for getting input from file
    // ifstream file("PES2UG19S396_sample.txt");   
    // int input; 
    // vector<int> names;
    // while(file >> input)    //returns file input until its over
    // {
    //     names.push_back(input);
    // }
    // int b = names.front();
    // int names_size = names.size(), c,d;
    int b,c,d; 
